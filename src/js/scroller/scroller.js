    ...
    */
    ...
    __publish: function (left, top, zoom, animate) {
        ...
        if (animate && me.options.animating) {
            ...
            me.__isAnimating = Animate.start(step, verify, completed, me.options.animationDuration, wasAnimating ? easeOutCubic : easeInOutCubic);
    ...
    */
    ...
    __stepThroughDeceleration: function (render) {
        ...
        if (me.options.bouncing) {
            ...
            var penetrationDeceleration = me.options.penetrationDeceleration;
            var penetrationAcceleration = me.options.penetrationAcceleration;
