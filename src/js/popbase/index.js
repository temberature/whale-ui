...
var Popbase = Class.extend({
    ...
    _doOpen: function () {
        ...
        if (modal) {
            if (this.isClosing) { // 如果正在执行关闭，则立刻关闭
            ...
            // 打开遮罩层
            popManager.openOverlay(this.instanceId(), fixOverlay ? undefined : nextZIndex, this.modalAppendToBody ? undefined : this.warp, this.modalClass, this.modalFade);
            if (this.lockScroll) { // 滚动锁定
