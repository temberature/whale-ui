...
/******/ 	return __webpack_require__(__webpack_require__.s = "bl4z");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = "<div class=\"lmui-progress-outer\">\n    <div class=\"lmui-progress-inner\">\n        <div class=\"lmui-progress-bg\" style=\"width: <%=type%>%\"></div>\n    </div>\n</div>\n<span class=\"lmui-progress-text\">\n    <%= format(percent) %>\n</span>";
...
__webpack_require__("RS3a");

var _index = __webpack_require__("O4bl");
...
var Progress = function (_EventClass) {
  _inherits(Progress, _EventClass);
  ...
  function Progress(options) {
    ...
    var _this = _possibleConstructorReturn(this, (Progress.__proto__ || Object.getPrototypeOf(Progress)).call(this, newOptions));

    _this._className = 'Progress';
    _this._initDom();
    return _this;
  }
